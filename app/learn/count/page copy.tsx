	...
	return (
		<main className={`main left height-full`}>
			...
			<p className={`paragraph width-full block left-align`}>
				There are a number of ways to go about approximating the impact of any
				action taken upon a space. One might simply guess, or intuit. One might
				calculate the curvature of a set of small assumptions and extrapolate
				based off of what arises from there. This is my preferred method.
				Indeed, when all we have to work with are ranges and approximations,
				this is often the way, as we discover through the course of an
				intermediate mathematical education.
			</p>
			<p className={`paragraph width-full block left-align`}>
