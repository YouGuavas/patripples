	...
	return (
		<main className={`main center height-full flex column`}>
			...
			<ul className="no-deco left-align width-full flex column gap-small">
				...
				<li>
					{' '}
					Engaged respectfully with vulnerable or disabled individuals—offering
					dignity, discussion, and a willingness to help.
				</li>
				<li>
					{' '}
			...
			<p className={`paragraph width-full block left-align`}>
				I&apos;m currently seeking work, mentorship, and a path forward—whether
				hands-on or hybrid, I&apos;m ready to show up. Feel free to reach out or
				follow along:
			</p>
