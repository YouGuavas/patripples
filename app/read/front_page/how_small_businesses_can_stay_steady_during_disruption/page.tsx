	...
	return (
		<main className={`main center`}>
			...
			<p className={`paragraph width-full block left-align`}>
				Edit (02/28/26): clarifying that this is not me taking a political
				stance. I was exploring the idea of riding waves of disruption within a
				morally acceptable bandwidth in order to capture search traffic. The
				result, though limited as this one-page sample size may be, has been
