	...
	return (
		<main className={`main center`}>
			...
			>
				...
				thorns. Man, this would be so much easier if I wasn&apos;t
				COLOR-BLIND!&quot;
			</blockquote>
			...
			<p className={`paragraph width-full block left-align`}>
				...
				layers to this idea. It&apos;s very complex. You likely intuit it better
				than I can over-explain it. I&apos;ll give it a shot anyway, for my
				ego&apos;s sake. Note any mistakes.
			</p>
			<h3
				className={`lowercase style-1 thin spaced left width-full block left-align`}
			>
			...
			<p className={`paragraph width-full block left-align`}>
				Envision some guy, or some she or some they, in deeper than all three of
				their heads in ecological slowdowns and economical log-jams. With the
				odds as stacked against them as the river&apos;s dam was wide, our
			...
			<p className={`paragraph width-full block left-align`}>
				...
				exchange does the opposite of what a walk and one sliced apple a day may
				do for you.
			</p>
			<p className={`paragraph width-full block left-align`}>
				As water seeps through, those toxins leach in. They seed and they bleed.
				You don&apos;t need me to teach; you can see where that leads. If
				untreated, from deep-rooted trees and untreaded greens beside an old
				stream with some reeds - to muck pooled like pus, all stinking and mean.
			</p>
			<p className={`paragraph width-full block left-align`}>
				It&apos;s not only water which gets trapped in this sauna - these tires
				mirror hoof-footed mooers in moving out methane. Only instead of manure,
				for this maneuver we&apos;ll use swamp stank instead. Synthetic rubbers
				are sort of like flammable gases which have been temporarily pressured
				into shaky stability. Have you seen that pattern expressed elsewhere?
			</p>
			<p className={`paragraph width-full block left-align`}>
				As if the stakes needed raising, these hoofless movers&apos; leftover
				shoe pit&apos;s changed the landscape through its carbon footprint, just
				to prove it could do it. Methane and swamp stank, water and muck, what
				more could these tires want, but a blueprint? Only the sun. They hold
				onto it tight - and in them it excites a long-linking chain which
				aspires to bring light, but instead just ignites.
			</p>

			<p className={`paragraph width-full block left-align`}>
				That got real dark. Remember those hairs - and what color their roots. I
				would not dare to split these entangling frayed ends, only give them a
				part.
			</p>
			<h2
				className={`lowercase style-1 thin spaced left width-full block left-align`}
			...
			<p className={`paragraph width-full block left-align`}>
				...
				boot, the image of ancient tires stagnating a stream into a steam swamp
				does not spring lightfooted to mind.
			</p>
			<p className={`paragraph width-full block left-align`}>
				...
				done so with care to seed micro-habitats for small animals, brace trees
				and their root systems, mitigate further erosion, and{' '}
			...
			<p className={`paragraph width-full block left-align`}>
				...
				purpose of this post, aside from dancing around lyrically, is to set the
				scene for transformation. This is the &quot;Before&quot;. When working
				in harmony with nature and its cycles, a great many bountiful
