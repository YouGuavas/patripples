		...
		<SpaceProviderWrapper>
			<main className={`main left-align`}>
				...
				>
					...
					<span className={`full`}>It visits with inconstant glance</span>{' '}
					<span className={`full`}>Each human heart and countenance;</span>
					<span className={`full`}>
					...
					<span className={`full`}>Like memory of music fled,</span>
					<br />
					<span className={`full`}>
						Like aught that for its grace may be Dear,
					</span>
					<span className={`full`}>and yet dearer for its mystery.&quot;</span>
				</blockquote>
				<br />
				<span className={`full`}>
				...
				<p className={`paragraph`}>
					...
					it tends not to wait, rather to wilt and wither - or ferment like sour
					vinegar. Sometimes an idea takes root in the heart, and sometimes in
					the mind. Often, it only blooms in time. If an idea requires time, and
					yet not to be left to linger, then we may come to ask ourselves:
					&quot;How can I fan at the flames which surround me not so much as to
					snuff my own lights out, only just enough to stretch the seeds of my
					insights out of their own stiff shells?&quot;
				</p>
				<p className={`paragraph`}>
					A plant is only as healthy as its garden. This means that, beyond its
					own direct self interest, a plant benefits from developing strong
					roots - strong roots make for strong gardens, after all. How can this
					flower - this idea do a thing like this? It is a flower, after all,
				...
				<p className={`paragraph`}>
					...
					thought - a worldwide hive full of bees wishing to be their own
					keepers.
				</p>
				<p className={`paragraph`}>
					...
					dandelion dancing in the wind, while from its head sips a
					dander-backed dancer: a nectar-drunk bumblebee, ready to buzz off to
					the next bulb, where it will drink more, dance more, and - more
					importantly - exchange plant matter.
				</p>
				<p className={`paragraph`}>
				...
				<p className={`paragraph`}>
					...
					in a symbiotic resource exchange of the mind. As with the bee, who
					gets to buzz and vibe its way to solid status in the hive - or with
					the bird who exchanges seed for seeds - we are giving and receiving
					raw data, processed through a specially-wired natural supercomputer
					which has been specialized over millennia to engage in just this sort
					of exchange. We really are an incredible species - and part of an even
				...
				<p className={`paragraph`}>
					...
					reached bloom: it first needed to be a seed, then someone had to buy
					it a bit of time, and give it some attention to boot. Only then could
					this seed - whose weeds needed weeding (
				...
				<p className={`paragraph`}>
					This is my first post, and I&apos;m making it as a promise to
					self-seed going forward. My aim with patripples is to create and share
					a mind garden. Each of us are pollinators and gardeners of ideas -
					cultivators of thought. Together, I believe we can foster a collective
					mind garden whose flowers bloom with such natural force that we are
					forced to reckon with ourselves - peacefully - and then spring forth
					smarter, wiser, and more collaborative than ever before.
				</p>
				<p className={`paragraph`}>
