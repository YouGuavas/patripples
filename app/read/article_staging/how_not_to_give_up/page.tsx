		...
		<main className={`main center`}>
			...
			<section>
				...
				<p className={`paragraph width-full block left-align`}>
					Everybody is overwhelmed by information and emotions. We are all
					trying our best to come up with ways to make sense of a tangled ball
					of knots.
				</p>
				<p className={`paragraph width-full block left-align`}>
			...
			<section>
				...
				<p className={`paragraph width-full block left-align`}>
					I think that a lot of small business websites come across as
					intimidating. Not all of them, but many.
				</p>
				<p className={`paragraph width-full block left-align`}>
