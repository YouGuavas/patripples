...
export default function Home() {
    return (
        <main className={`main center`}>
            ...
            <p className={`paragraph width-full block left-align`}>
                In nature, erosion can be understood as a form of emergence via causal complexity (similar to a &quot;synchronicity&quot; in <Link href="https://en.wikipedia.org/wiki/Carl_Jung" className="no-deco spaced">Jungian psychology</Link>, except that the cause is complex and multifactorial, rather than nonexistent). When one wishes to map a causally complex emergence, one must employ a branch of mathematics called &quot;tensor analysis&quot; (or <Link href="https://en.wikipedia.org/wiki/Ricci_calculus" className="no-deco spaced">Ricci calculus</Link>), which I will touch on in depth later. For now, understanding that this technique exists and that it may be used in this way will suffice.
            </p>
            <p className={`paragraph width-full block left-align`}>
                Without even <em>understanding</em> it, erosion may be <em>observed</em> as a continuous occurrence: the constant redistribution of resources, through natural forces (such as wind, water flow, and even shoefall on soil), taken disproportionately from a given locale. We may observe various stages of erosion especially at the edges of any <em>unnaturally</em> formed body of water, or wherever humans habitually tread. Like a sandy warzone.
            </p>
            <p className={`paragraph width-full block left-align`}>
...
<p className={`paragraph width-full block left-align`}>
    Narcissism, named for the vain Greek youth of myth, <Link href="https://en.wikipedia.org/wiki/Narcissus_(mythology)" className="spaced no-deco">Narcissus</Link> - who fittingly fell smitten with his own reflection - represents a second mirror to Solipsism. Differing from Nihilism, Narcissism manifests as the replacement of the non-self with an often-unquestionable false self.
            </p>
...
<p className={`paragraph width-full block left-align`}>
           ...
           <p className={`paragraph width-full block left-align`}>
            It was <Link href="https://en.wikipedia.org/wiki/Baruch_Spinoza" className="spaced no-deco">Baruch Spinoza</Link>, in the 1677 treatise, &apos;<em>Ethics</em>,&apos; who differentiated between <em>natura naturata</em> (nature natured), and <em>natura naturans</em> (nature naturing). Spinoza explored these concepts in the context of understanding God. I call them forth here with a mind to highlight <em>what is</em>, <em>what is happening</em>, and what I feel is our current misalignment as a species of planetary stewards from our collective natura naturans. Our &quot;what we <em>should</em> be doing.&quot;
            </p>
            <p className={`paragraph width-full block left-align`}>
            ...
            <p className={`paragraph width-full block left-align`}>
                Man&apos;s having made that lake, and the subsequent erosion which has occurred since (including our nihilist tree) represents, to me, a kind of <em>naturata</em>. Recall that this word means &quot;natured.&quot; That means that it exists (vs something which is coming to exist). This concept covers the present-day results of past actions. If the <em>naturata</em> of today is &quot;crumbling, erosion, and decay,&quot; and we want anything to change, then we must ask ourselves what sort of <em>naturata</em> we will leave behind for future generations. That remains to be seen.
            </p>
            <p className={`paragraph width-full block left-align`}>
                We are still living out our <em>naturans</em>. This may feel abstract, or even intimidating, but all I am saying is this: &quot;It ain&apos;t over &apos;til the fat lady sings.&quot;
            </p>
            <p className={`paragraph width-full block left-align`}>
                We&apos;ll dig more into Spinoza&apos;s <em>naturans</em> later. At this time, its chief significance lies in the truth that each of us alive today holds within the power to alter tomorrow&apos;s realities, however subtly.
            </p>
...
<p className={`paragraph width-full block left-align`}>
            ...
            <p className={`paragraph width-full block left-align`}>
                Come what may tomorrow, our tree gave way yesterday. Whenever I witness a tree&apos;s falling, or consider the craters and the gashes long left in land the world over, I ask myself what might have prevented it. Concerning our nihilist tree, I see a line into history. You see, an erosion-fallen tree is one facet of the <em>naturata</em> of narcissistic (or even Solipsistic) land management.
            </p>
            <p className={`paragraph width-full block left-align`}>
                The <Link href="https://lotr.fandom.com/wiki/Destruction_of_Isengard" className="spaced no-deco">ents at Isengard</Link> agree with me. Their solution was to topple the narcissist tower, let empathy flood the land and fill their roots, then re-establish their interdependent tree community. What will our solution be?
            </p>
            <br />
            <hr />
            <br />
           <p className={`paragraph width-full block left-align`}>
            ...
            <p className={`paragraph width-full block left-align`}>
            Where my silent-sitting vessel loudly lay, once a man worked every day. He toiled in muck and soil, taking only leaves and feathers as pay. He did this in hope that <em>your</em> descendants might keep on patch of un-hole-y land, where they may sleep, and they may play.
            </p>
            <p className={`paragraph width-full block left-align`}>
            What do you see in your far-flung future when you squabble with your neighbor while foul nations poke holes in <em>your</em> nature? Will you wake one day, shaken by the realization that the last lighthouse now sits, ashen, at the root of an ash tree?
            </p>
            <p className={`paragraph width-full block left-align`}>
