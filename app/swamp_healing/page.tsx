		...
		<SpaceProviderWrapper>
			<main className={`main center height-full flex column`}>
				...
				<p className={`paragraph width-full block left-align`}>
					...
					— independent researcher, ecosystem restorer, and field-based
				...
				<p className={`paragraph width-full block left-align`}>
					This project restores neglected wetlands and swampy habitats,
					especially those compromised by human waste, erosion, and artificial
					pooling. Using natural methods—including branch wicking, sunlight
					exposure, strategic airflow modulation, and debris repositioning—I
					accelerate ecological recovery while reducing mosquito populations,
					methane emissions, and microclimatic instability.
				</p>
				<p className={`paragraph width-full block left-align`}>
				...
				<ul className="no-deco left-align width-full flex column gap-small">
					...
					<li>
						Removed waste (tires, glass, plastic) and repurposed objects to
						reduce swamp overcapacity.
					</li>
					<li>
				...
				<ul className="no-deco left-align width-full flex column gap-small">
					...
					<li>
						...
						feel comfortable being on the land - I don&apos;t want to trespass
						or step on toes. I work intuitively and responsively with the land.
						...
						observations often lead me toward sites with ecological stress. I
						have a drone that I would like to use for documentation purposes,
						and want to be respectful with that.
					</li>
					<li>
				...
				<ul className="no-deco left-align width-full flex column gap-small">
					...
					<li>
						...
						content, and can envision live work as well - I have a group around
						me who would love to learn about this - some are local elementary
				...
				<ul className="no-deco left-align width-full flex column gap-small">
					...
					<li>
						Educational: Offers a compelling hands-on model for young
						ecologists, urban planners, and environmental science storytellers.
					</li>
				</ul>
				<h2 className={`style-1 lowercase width-full left-align thin`}>
					Looking Forward:
				...
				<p className={`paragraph width-full block left-align`}>
					Your support will allow me to scale what&apos;s already working —
					while capturing and translating the process into visual, open tools
					that help others understand their own potential ripple effect. I
					intend to model swamp stewardship not as a clean-up job, but as civic
					science with planetary impact.
				</p>
			</main>
		</SpaceProviderWrapper>
	);
