		...
		<main className={`main left px-1`}>
			...
			<ul className={`no-deco flex column gap-small`}>
				<li>
					...
					fester breathe instead. I believe that this sort of action - a healing
					one, done in harmony with what is - always leaves behind a positive
					ripple.
				</li>{' '}
				<li>
					Accelerating Empathy - Deep empathy - for each other, of course; also
					for all living beings, and for the planet on which we all reside -
					improves outcomes for everyone. The mathematics of this checks out. It
					will prove itself. Or you can look up mid-term and long-term financial
					outcomes in societies who historically have prized health and
					ecological harmony vs those who have prioritized industry.
				</li>
			...
			<p>
				...
				site a little bit. See what clicks with you. That seems to work for the
				dolphins.
			</p>
			...
			<ul className={`no-deco`}>
				...
				<li>
					Visual Explorations – Mathematical and conceptual visualizations that
